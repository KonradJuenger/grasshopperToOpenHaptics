...
namespace ghoh
{
    public class ghohSetForce : GH_Component
    {
        ...
        public ghohSetForce() : base(
            "ghohSetForce",
            "SetForce",
            "Sets force to the haptic device with optional filtering",
            "ghoh",
            "device")
        {
        }
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddBooleanParameter("FilterEnabled", "Filt", "Enable force filtering", GH_ParamAccess.item, true);
